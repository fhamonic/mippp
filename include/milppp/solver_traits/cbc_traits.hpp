...
struct CbcTraits {
    ...
    static CbcModel build(OptSense opt_sense,
        ...
        CoinPackedMatrix * matrix = new CoinPackedMatrix(false, nb_vars, nb_rows, nb_elems, coefs, indices, row_begins_copy, nullptr);
        delete[] row_begins_copy;
        // ownership of copies and matrix is transfered to solver
        solver->assignProblem(matrix, col_lb_copy, col_ub_copy, obj_copy, row_lb_copy, row_ub_copy);
