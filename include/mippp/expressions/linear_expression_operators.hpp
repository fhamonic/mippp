...
[[nodiscard]] constexpr auto operator-(E1 && e1, E2 && e2) {
    return linear_expression_add<E1 &&, linear_expression_negate<E2 &&>>(
        std::forward<E1>(e1),
        linear_expression_negate<E2 &&>(std::forward<E2>(e2)));
};
...
template <linear_expression_c E>
[[nodiscard]] constexpr auto operator-(expression_scalar_t<E> c, E && e) {
    return linear_expression_scalar_add<linear_expression_negate<E &&>>(
        linear_expression_negate<E &&>(std::forward<E>(e)), c);
};
