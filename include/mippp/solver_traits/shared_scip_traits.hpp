...
struct shared_scip_traits {
    ...
    struct solver_wrapper : public abstract_solver_wrapper {
        ...
        [[nodiscard]] solver_wrapper(const auto & m_model) : model(nullptr) {
            using traits =
            ...
            typename traits::var_category const * vtype =
            ...
            vars = std::vector<SCIP_VAR *>(static_cast<std::size_t>(nb_vars),
                                           nullptr);
