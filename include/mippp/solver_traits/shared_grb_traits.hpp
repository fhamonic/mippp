...
struct shared_grb_solver_wrapper : public abstract_solver_wrapper {
    ...
    [[nodiscard]] shared_grb_solver_wrapper(const auto & model)
        : env(nullptr), model(nullptr) {
        shared_grb_traits::opt_sense sense = model.optimization_sense();
        ...
        shared_grb_traits::var_category * vtype =
            const_cast<shared_grb_traits::var_category *>(model.column_types());
