...
[![Generic badge](https://img.shields.io/badge/C++-26-blue.svg?style=flat&logo=c%2B%2B)](https://en.cppreference.com/w/cpp/26)
...
- **Modern C++26**: Utilizes ranges, lambdas, and template metaprogramming for an elegant and efficient API allowing a Pythonic syntax.
...
- Improve callback support for lazy constraints and user cuts
