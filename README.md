...
Library attempting to provide an elegant and efficient way for instanciating Mixed Integer Linear Programs for multiple MILP solver (actually CBC and GUROBI).
