...
- **Header-only**: Dynamically loading the C API of a variety of solvers (Gurobi, Clp, CBC, GLPK, Highs, etc.) allows Mippp to stay header-only and easy to integrate to C++ projects.
...
### Conan Center package (upcomming release)
