...
using M = mip_model<shared_cplex_traits>;

GTEST_TEST(shared_cplex_model, default_constructor) {
    model_tests<M>::default_constructor();
}
GTEST_TEST(shared_cplex_model, add_variable_default_name_default_options) {
    model_tests<M>::add_variable_default_name_default_options();
}
GTEST_TEST(shared_cplex_model, add_variable_default_name_custom_options) {
    model_tests<M>::add_variable_default_name_custom_options();
}
GTEST_TEST(shared_cplex_model, add_variable_custom_name_default_options) {
    model_tests<M>::add_variable_custom_name_default_options();
}
GTEST_TEST(shared_cplex_model, add_variable_custom_name_custom_options) {
    model_tests<M>::add_variable_custom_name_custom_options();
}
GTEST_TEST(shared_cplex_model, add_variables_default_name_default_options) {
    model_tests<M>::add_variables_default_name_default_options();
}
GTEST_TEST(shared_cplex_model, add_variables_default_name_custom_options) {
    model_tests<M>::add_variables_default_name_custom_options();
}
GTEST_TEST(shared_cplex_model, add_variables_custom_name_default_options) {
    model_tests<M>::add_variables_custom_name_default_options();
}
GTEST_TEST(shared_cplex_model, add_variables_custom_name_custom_options) {
    model_tests<M>::add_variables_custom_name_custom_options();
}
GTEST_TEST(shared_cplex_model, add_to_objective) {
    model_tests<M>::add_to_objective();
}
GTEST_TEST(shared_cplex_model, get_objective) {
    model_tests<M>::get_objective();
}
GTEST_TEST(shared_cplex_model, add_and_get_constraint) {
    model_tests<M>::add_and_get_constraint();
}
GTEST_TEST(shared_cplex_model, build_optimize) {
    model_tests<M>::build_optimize();
}
GTEST_TEST(shared_cplex_model, add_to_objective_xsum) {
